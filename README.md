...
> - **Zamanlayıcı ve Doğal Seslendirme:** Kararsız tahminleri süzmek için **%50 güven eşiği** (confidence threshold) ve 2 saniyelik zamanlayıcı algoritması eklenmiş; oluşan kelimeler Microsoft Edge-TTS'in yapay zeka Türkçe ses modeli (`tr-TR-AhmetNeural`) ile insan sesine yakın kalitede seslendirilmiştir.
